...
let crc = crc32('hello');  // 907060870
crc = crc32('world', crc);  // 4192936109

crc = crc32(Buffer.from('hello', 'utf16le'));  // 1427272415
crc = crc32(Buffer.from('world', 'utf16le'), crc);  // 4150509955
```
