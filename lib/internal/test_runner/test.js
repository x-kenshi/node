...
class Test extends AsyncResource {
  ...
  matchesTestNamePatterns() {
    ...
    } else if (skipNamePatterns !== null {
      patterns = skipNamePatterns;
      boolOp = 1;
...
class Suite extends Test {
  ...
  constructor(options) {
    ...
    if ((testNamePatterns !== null || skipNamePatterns !== null) && !options.skip) {
  ...
  postBuild() {
    ...
    if (this.filtered && this.filteredSubtestCount !== this.subtests.length) {
      ...
      this.filtered = false;
      this.parent.filteredSubtestCount--;
    } else if (testOnlyFlag && testNamePatterns == null && skipNamePatterns == null && this.filteredSubtestCount === this.subtests.length) {
