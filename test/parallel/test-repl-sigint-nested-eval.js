...
child.on('close', function(code) {
  ...
  assert.includes(stdout, expected, `Expected stdout to contain "${expected}", got ${stdout}`);
  assert.includes(stdout, 'foobar', `Expected stdout to contain "foobar", got ${stdout}`);
});
